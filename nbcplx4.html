...
<html lang="fr">
	...
	<h2>Formes exponentielles des nombres complexes (4/4) </h2> 
			<video controls src="./video/cmplx4" id="center" height=300 width=500></video></div>
	</main>
