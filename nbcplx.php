...
<html lang="fr">
	...
	<main>
	<h2>Introduction aux nombres complexes (1/4) </h2> 
			<video controls src="./video/cmplx1" id="center" height=300 width=500></video></div>
	</main>
...
<script src="formu.js"></script>
	...
	<footer>
       			<a href="nbcplx2.php" class="btn">page suivante</a>
			</br>
			</br>
