...
<html lang="fr">
	...
	<h2>Formes trigonométriques des nombres complexes (3/4) </h2> 
			<video controls src="./video/cmplx3" id="center" height=300 width=500></video></div>
	</main>
...
<div id="results"></div>
<script src="formu3.js"></script>

	</body>
	
	<footer>
			</br>
       			<a href="nbcplx4.php" class="btn">page suivante</a>
			</br>
			</br>
